...
public class BattlePlayer extends JPanel
{
  ...
  public BattlePlayer(BattleFrame s, int n)
  {
    sup = s;
    playerNo = n;
  ...
  //CONFIRM THE PLAYER HAS CHANGED BEFORE SHOWING THE BOARD
  ...
  public boolean receiveShot(int index)
  {
    if(friendSea.get(index).getForeground() == Color.GREEN)
    {
